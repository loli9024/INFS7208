...
class Upload extends CI_Controller {
    ...
    private function insertVideoData ($filePath){
        ...
        $data['uploadedBy'] =  get_cookie('userLoggedIn') ;
        ...
        $data['filePath'] = $filePath;
            ...
            $subscriptions = $this->user_model->getSubscribers(get_cookie('userLoggedIn'));

            foreach($subscriptions as $row){
    
                $notification['message']='New video called '.$_POST["title"].' uploaded by '.get_cookie('userLoggedIn');
                $notification['user_from']=get_cookie('userLoggedIn');
